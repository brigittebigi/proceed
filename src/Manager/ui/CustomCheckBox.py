...
def GetCheckedImage(CCB_MULTIPLE = False):
    ...
    if CCB_MULTIPLE is True:
        return wx.Image(CHECKED_ICON, wx.BITMAP_TYPE_ICO)
    # radiobox
    return wx.Image(RADIOCHECKED_ICON, wx.BITMAP_TYPE_ICO)
...
def GetNotCheckedImage(CCB_MULTIPLE = False):
    # checkbox
    if CCB_MULTIPLE is True:
        return wx.Image(UNCHECKED_ICON, wx.BITMAP_TYPE_ICO)
    # radiobox
    return wx.Image(RADIOUNCHECKED_ICON, wx.BITMAP_TYPE_ICO)
...
class CustomCheckBox( wx.PyControl ):
    ...
    def SetLabel(self, label):
        ...
        wx.PyControl.SetLabel(self, label.strip())
    ...
    #    return wx.PyControl.GetLabelText()
