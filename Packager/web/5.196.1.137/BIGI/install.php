...
<body> 
    ...
    <div class="cols12 section1">
        ...
        <div class="cols5 mg-top1 left">
            ...
            <h1 class="title0 left cols10">Installing dependencies on Windows</h1>
            ...
            <h1 class="title0 left cols10">Dependencies installation on Linux</h1>
            ...
            <h1 class="title0 left cols10">Dependencies installation on MacOS</h1>
