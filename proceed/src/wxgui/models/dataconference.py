...
class Conference :
    ...
    def __init__(self, conference_name="", place=0, date_from="", date_to=""):
        """
    ...
    def prepare_save(self):
        ...
        return [{"CONFERENCE_NAME":c, "PLACE":p, "DATE_FROM":f, "DATE_TO":t}]
